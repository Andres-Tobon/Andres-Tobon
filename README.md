...
<table width="100%" style="margin-top: 30px; border-collapse: separate; border-spacing: 0 10px; margin-bottom: 30px">
  <tr>
    <td width="55%" valign="top" style="padding: 20px; text-align: left;">
      ...
      <p style="line-height: 1.6;">
        Currently, my mission is to revolutionize AI with <strong><a href="https://github.com/Andres-Tobon/ithos" style="color: #00f7ff;">ITHØS powered by AIDriven</a></strong>, a next-generation AI, getting really close to a fully functional AGI system <i>no-code</i> platform.
      </p>
    </td>
...
<div align="center" style="padding: 20px;">
  ...
  <p style="margin-bottom: 20px;"><img src="https://skillicons.dev/icons?i=python,fastapi,nodejs,express,tensorflow,cpp,mysql,postgresql,redis,mongodb&theme=dark" alt="Backend and Database Technologies" /></p>
  
  <p style="font-size: 1.1em; font-weight: bold; color: #ffffff; margin-top: 30px;">DevOps,Cloud & Tools</p>
  <p><img src="https://skillicons.dev/icons?i=docker,linux,git,github,kubernetes,githubactions,bash,ubuntu,vscode&theme=dark" alt="DevOps and Cloud Technologies" /></p>
  
  <p style="font-size: 1.1em; font-weight: bold; color: #ffffff; margin-top: 30px;">Currently Learning</p>
  <p><img src="https://skillicons.dev/icons?i=aws,azure,terraform,ansible,gcp&theme=dark" alt="DevOps and Cloud Technologies" /></p>
</div>
